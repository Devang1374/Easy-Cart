...
new class extends Component
{
    ...
    public function banners(){
        return Banner::latest()->when($this->search, function($query){
                    ...
                    <flux:table.row>
                        ...
                        <flux:table.cell>
                            ...
                            @if($banner->desktop_image)
                                ...
                                >
                            @else
                                <div class="flex h-14 w-24 items-center justify-center rounded-lg bg-zinc-100 text-xs dark:bg-zinc-800">
                                    No Image
                                </div>
                            @endif
                        ...
                        <flux:table.cell>
                            ...
                            <flux:button
                                wire:click="showCreate({{ $banner->id }})"
                                variant="primary"
                                size="sm"
                            >
                                Edit

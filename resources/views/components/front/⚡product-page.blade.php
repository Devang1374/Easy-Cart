...
new class extends Component {
    ...
    {
        $this->categories = Category::query()->where('is_active', true)->get();
...
<div>
    ...
    <section class="mx-auto max-w-7xl px-6 py-8">
        ...
        <div class="mb-6 grid grid-cols-2 gap-4">
            ...
            <flux:input wire:model.live.debounce.500ms="search" placeholder="Search products..." />
        </div>
    </section>
    ...
    <section id="products-grid" class="mx-auto max-w-7xl px-6 py-8">
        ...
        <div wire:loading wire:target="search,sort,page"
            class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">

            @for ($i = 0; $i < 10; $i++)
                <div
                    class="overflow-hidden rounded-3xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">

    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="sticky top-0 border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                ...
                <flux:navbar.item icon="layout-grid" :href="route('returns')" :current="request()->routeIs('returns')" wire:navigate>
                    {{ __('Returns') }}
                </flux:navbar.item>
        ...
        <flux:sidebar collapsible="mobile" sticky class="lg:hidden border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Platform')">
                    ...
                    <flux:sidebar.item icon="layout-grid" :href="route('returns')" :current="request()->routeIs('returns')" wire:navigate>
                        {{ __('Returns')  }}
                    </flux:sidebar.item>
